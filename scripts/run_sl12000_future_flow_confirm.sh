...
OUT_DIR=${OUT_DIR:-"$ROOT/results/portable_assignment/sl12000_future_flow_confirm"}
TIMESTEPS=${1:-1000}
OUTPUT="$OUT_DIR/sl12000_futureflow_fw0p01_noregret_lns10_t${TIMESTEPS}.json"
LOG="$OUT_DIR/sl12000_futureflow_fw0p01_noregret_lns10_t${TIMESTEPS}.log"
