...
# Independent five-seed Table 2 screen for the Table 1 free-reassignment setting.
...
printf '\n\a========== TaskMatcher Table 2 free-reassignment screen complete ==========\n'
date '+Completed at %F %T %Z'
wall 'TaskMatcher Table 2 free-reassignment screening has completed.' 2>/dev/null || true
if command -v notify-send >/dev/null 2>&1; then
  notify-send --urgency=normal 'TaskMatcher experiment complete' \
    'The Table 2 free-reassignment screen has finished.' || true
fi
