...
# Long confirmation of the W500 traffic top-k screen winner.
ROOT=$(cd "$(dirname "${BASH_SOURCE[0]}")/.." && pwd)
BIN=${BIN:-"$ROOT/build/lifelong"}
OUT_DIR="$ROOT/results/portable_assignment/traffic_topk_w500_confirm"
TIMESTEPS=${1:-1000}
OUTPUT="$OUT_DIR/w500_k100_cw1p0_t${TIMESTEPS}.json"
LOG="${OUTPUT%.json}.log"
...
echo "Running W500 traffic-k100 congestion-weight=1.0 for $TIMESTEPS steps"
...
printf '\n\a========== W500 traffic top-k 100 confirmation complete ==========\n'
