...
# Complete the 25-seed paired confirmation. Seeds 0--4 from the initial
# screen are reused when valid; this script adds seeds 5--24 serially.
...
printf '\a========== Table 2 lexicographic pickup 25-seed confirmation complete ==========\n'
date '+Completed at %F %T %Z'
printf '\aTable 2 lexicographic pickup 25-seed results are ready.\n' | wall 2>/dev/null || true
